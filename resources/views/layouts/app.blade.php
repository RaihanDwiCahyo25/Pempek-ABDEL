        ...
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 pr-4">
                ...
                <div class="flex space-x-3">
                    <!-- Icon WhatsApp -->
                    <a href="https://wa.me/6289527235298" target="_blank" class="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center text-white hover:bg-yellow-500 transition shadow-sm">
                    ...
                    <!-- Icon Instagram -->
                    <a href="#" target="_blank" class="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center text-white hover:bg-yellow-500 transition shadow-sm">
