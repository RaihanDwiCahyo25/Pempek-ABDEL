                ...
                <section class="grid gap-8 lg:grid-cols-[360px_minmax(0,_1fr)]">
                    <div class="rounded-3xl border border-gray-200 bg-slate-50 p-6 shadow-sm">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-3">Preview Logo Halal</label>
                                <div class="rounded-3xl border border-dashed border-gray-300 bg-white p-5">
                                    <div class="h-24 w-full overflow-hidden rounded-3xl bg-gray-100 flex items-center justify-center">
                                        @if(optional($setting)->halal_logo_path)
                                            <img src="{{ asset('storage/' . $setting->halal_logo_path) }}" alt="Logo Halal" class="h-full object-contain" />
                                        @else
                                            <span class="text-sm text-gray-400">Logo Halal belum diunggah</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-3">Preview Logo BPOM</label>
                                <div class="rounded-3xl border border-dashed border-gray-300 bg-white p-5">
                                    <div class="h-24 w-full overflow-hidden rounded-3xl bg-gray-100 flex items-center justify-center">
                                        @if(optional($setting)->bpom_logo_path)
                                            <img src="{{ asset('storage/' . $setting->bpom_logo_path) }}" alt="Logo BPOM" class="h-full object-contain" />
                                        @else
                                            <span class="text-sm text-gray-400">Logo BPOM belum diunggah</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
                        ...
                        <div class="grid gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Upload Logo Halal (opsional)</label>
                                <input type="file" name="halal_logo" class="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500" />
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Upload Logo BPOM (opsional)</label>
                                <input type="file" name="bpom_logo" class="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500" />
                            </div>
